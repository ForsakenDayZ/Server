...
[nil,nil,rTitleText,"Unknown Radio Transmission:\nI see a couple of death squads setting up a weapons cache!", "PLAIN",10] call RE;
...
[nil,nil,rTitleText,"Unknown Radio Transmission:\nSurvivors just took over the weapons cache!", "PLAIN",6] call RE;
