...
if (true) then
{
  _this = createVehicle ["HeliHEmpty", [15558.97, 16440.412], [], 0, "CAN_COLLIDE"];
  _vehicle_79 = _this;
  _this setDir 90.0;
  _this setPos [15558.97, 16440.412];
};
...
if (true) then
{
  _this = createVehicle ["HeliHCivil", [15558.97, 16440.412], [], 0, "CAN_COLLIDE"];
  _vehicle_129 = _this;
  _this setDir 90.0;
  _this setPos [15558.97, 16440.412];
};
