...
if (_spawnRoll <= _spawnChance) then
{
	...
	_position = [getMarkerPos _spawnMarker,0,_spawnRadius,10,0,2,0] call BIS_fnc_findSafePos;
	...
	if(_preWaypoints > 0) then
	{
		...
		{
			_preWaypointPos = [getMarkerPos _spawnMarker, 0, _spawnRadius, 10, 0, 2, 0] call BIS_fnc_findSafePos;
	...
	else
	{
		...
		if(_show_marker) then {
			...
			_marker_position = [_pos,0,_markerRadius,0,1,2,0] call BIS_fnc_findSafePos;
