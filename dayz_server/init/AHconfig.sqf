...
[
"76561198116192616",//Fatboi
"76561198076431453",//R3AP3R
"76561198090037641",//Skinner
"76561198106545535"//Sweets
]; //do not have a , at the end.
/*  BANNED PLAYER HERE    */ _BLOCKED = ["0","0","0"]; //do not have a , at the end.

/* ********************************************************************************* */
/*  Top esc menu TXT      */ _TopOfESC = "Zombie Battalion"; //do not use " in this text.
/*  Bottom esc menu TXT   */ _LowerTop = "ts3.zombiebattalion.net"; //do not use " in this text.
/*  Bottom esc menu TXT2  */ _LowerBottom = "www.zombiebattalion.net"; //do not use " in this text.
/*  Color esc menu TXT    */ _EscColor = [0.6,0,0,1];
/*  DebugMonitor TXT      */ _BottomDebug = "Zombie Battalion"; //do not use " in this text.
...
_ALLOWED_Dialogs = [-1,106,2200,6900,6901,6902,6903,420420,41144,711194,55510,711197,2800,3800,8101];
...
[
	...
	"BTC_Hud","PlotManagement","#USER:Airdrop"
];
...
[
	...
	"s_player_dogStay","s_player_dogFollow","s_player_dogFind","s_player_Airdrop","The_DropAction3","The_DropAction2","The_DropAction1","The_DropAction"
];
/* ********************************************************************************* */
	//	NEW (EXPERIMENTAL):
