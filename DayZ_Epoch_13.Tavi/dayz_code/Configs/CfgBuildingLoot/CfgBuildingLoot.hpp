...
class CfgBuildingLoot {
	...
	class Castle: Default {
		...
		lootPos[] = {};
		lootType[] = {
			{"ItemKnife","weapon",0.3},
			{"ItemMap","generic",0.3},
			{"ItemCompass","weapon",0.3},
			{"ItemFlashlight","weapon",0.3},
			{"ItemSledgeHead", "magazine", 0.1},
			{"ItemSledgeHandle", "magazine", 0.1},
			{"WeaponHolder_ItemHatchet","object",0.3},
			{"WeaponHolder_ItemTent","object",0.3},
			{"PartWoodPile","magazine",0.3},
			{"","generic",0.40}
		};
	};
	...
	class Industrial: Default {
		...
		lootPos[] = {};
		lootType[] = {
			{"ItemGenerator","magazine",0.04},
			{"ItemFuelBarrelEmpty","magazine",0.04},
			{"","generic",0.17},
			{"","trash",0.25},
			{"","military",0.04},
	...
	class Farm: Default {
		...
		lootType[] = {
			...
			{"","generic",0.3},
			{"","trash",0.18},
			{"PartPlankPack","magazine",0.18},
			{"WeaponHolder_ItemHatchet_DZE","object",0.20},
	...
	class HeliCrash_No50s: Default {
		...
		lootType[] = {
			...
			{ "MedBox0", "object", 0.05 },
			{ "NVGoggles", "weapon", 0.01 },
			{ "M107_DZ", "weapon", 0.007 }, // high value
			{ "DMR_DZ", "weapon", 0.05 }, // high value
			{ "M14_EP1", "weapon", 0.01 }, // high value
			{ "vil_M110sd", "weapon", 0.01 }, // high value
			{ "vil_SR25SD", "weapon", 0.01 }, // high value
			{ "vil_SR25", "weapon", 0.01 }, // high value
			{ "BAF_LRR_scoped_W", "weapon", 0.01 }, // high value
			{ "SCAR_H_STD_EGLM_Spect", "weapon", 0.01 }, // high value
			{ "SCAR_H_LNG_Sniper", "weapon", 0.01 }, // high value
			{ "FHQ_MSR_DESERT", "weapon", 0.01 }, // high value
			{ "FHQ_RSASS_TAN", "weapon", 0.01 }, // high value
			{ "AmmoBoxSmall_556", "object", 0.03 },
			{ "AmmoBoxSmall_762", "object", 0.03 },
			{ "militaryclothes", "militaryclothes", 0.05 },
			{ "militaryammo", "militaryammo", 0.06 },
	...
	class Military: Default {
		...
		lootType[] = {
			...
			{"ItemGPS","weapon",0.01},
			{"militarybackpacks","militarybackpacks",0.4},
			{"","medical",0.03},
			{"","generic",0.1},
			{"","military",0.3},
